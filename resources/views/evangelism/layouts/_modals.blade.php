        ...
        <div class="bootstrap-modal">
            <div class="modal fade adminuserdetail" tabindex="-1" role="dialog" id="myadminuserdetail" aria-labelledby="myadminuserdetail" aria-hidden="true">
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="myadminuserdetail">Add Admin User</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                                ...
                                <div class="card p-4">
                                    <div class="card-body">
                                            ...
                                            <div class="col-9">
                                                <div class="md-2">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-5 text-dark" id="text_name"></div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-3">Email: </div>
                                                        <div class="col-5 text-dark" id="text_email"></div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-3">Phone: </div>
                                                        <div class="col-5 text-dark" id="text_phone"></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-3">
                                                <div class="md-2">
                                                    <div id="a_img_src"></div>
                                                        <div id="img_tag_name">
                                        ...
                                        <div class="row mb-lg-3">
                                            <div class="col-6">
                                                <div>USERNAME</div>
                                                <p id="text_username" class="text-dark"></p>
                                            </div>
                                            <div class="col-6">
                                                <div>E-MAIL</div>
                                                <p id="text_email2" class="text-dark"></p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-lg-3">
                                            <div class="col-6">
                                                <div>USER CODE</div>
                                                <p id="text_user_code" class="text-dark"></p>
                                            </div>
                                            <div class="col-6">
                                                <div>USER ROLE</div>
                                                <p id="text_user_role" class="text-dark"></p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-lg-3">
                                            <div class="col-6">
                                                <div>GENDER</div>
                                                <p id="text_gender" class="text-dark"></p>
                                            </div>
                                            <div class="col-6">
                                                <div >PHONE</div>
                                                <p id="text_phone2" class="text-dark"></p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-lg-3">
                                            <div class="col-6">
                                                ...
                                                <p id="text_chapter" class="text-dark"></p>
                                            </div>
                                            <div class="col-6">
                                                <div>USER STATUS</div>
                                                <p id="text_user_state" class="text-dark"></p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-lg-3">
                                            <div class="col-6">
                                                ...
                                                <p id="text_verified" class="text-dark"></p>
                                            </div>
                                            <div class="col-6">
                                                <div>USER ID</div>
                                                <p id="text_id" class="text-dark"></p>
                                            </div>
                                        </div>

                                        <div class="row mb-lg-3">
                                            <div class="col-6">
                                                <div>DATE CREATED ACCOUNT</div>
                                                <p id="text_date_created"></p>
                                            </div>
                                            <div class="col-6">
                                                <div>DATE ACCOUNT UPDATED</div>
                                                <p id="text_date_updated" class="text-dark"></p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-lg-3">
                                            <div class="col-12">
                                                <div>ABOUT ADMIN</div>
                                                <textarea disabled readonly rows="5" id="text_about_user" class="text-dark" style="width: 100%;">
                                                </textarea>
                                            </div>
                                        </div>
