                                                    ...
                                                    @foreach ($getRecord as $row)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="avascript:void(0)" id="{{ $row->id }}" class="restore_new_soul_btn mx2" title="Restore New Soul"><i class="ri-restart-line text-danger" style="font-size: 20px;"></i></a>
                                                                
                                                                <a href="avascript:void(0)" id="{{ $row->id }}" class="perm_delete_new_soul_btn mx-2" title="Delete New Soul"><i class="ri-delete-bin-2-line text-danger" style="font-size: 20px;"></i></a>
