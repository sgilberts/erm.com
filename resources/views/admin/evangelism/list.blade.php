...
@endsection
                        ...
                        <!-- end page title -->
                            ...
                            @if (Auth::user()->verified == 1)
                                <div class="row  mb-3">
                                    ...
                                    <div class="col-md-2">
                                        <button id="add_new_soul_btn" class="btn btn-primary add_new_soul_btn" style="width: 100%">Add New Soul</button>
                                    </div>
                                </div> 
                            @endif
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12" style="display: none;" id="add_new_soul_div">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title">Add New Soul</h4>
                                            <p class="card-title-desc">Provide valuable, information of the new soul.</p>
                                            <p class="text-danger" id="passError"></p>
                                            <form action="{{ url('add_new_soul') }}" method="POST" class="needs-validation">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            <label for="report_info" class="form-label">Interest</label>
                                                            <input class="form-control" type="text" name="report_info" required placeholder="Report Information" id="report_info" >
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="mb-6">
                                                            <div>
                                                                <input id="registerftBtn" class="btn btn-primary" type="submit" value="Add New Soul" style="width: 100%;"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12" style="display: none;" id="edit_new_soul_div">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title">Update New Soul</h4>
                                            <p class="card-title-desc">Provide valuable, information of new soul.</p>
                                            
                                            <form action="{{ url('update_new_soul') }}" method="POST" class="needs-validation">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="edit_report_info" class="form-label">Report Information</label>
                                                        <input class="form-control" type="text" name="report_info" id="edit_report_info" >
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="mb-6">
                                                        <div>
                                                            <input id="updateftBtn" class="btn btn-primary" type="submit" value="Update New Soul" style="width: 100%;"/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-xl--12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h3 class="card-title">New Souls</h3>
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($getRecord as $row)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="avascript:void(0)" id="{{ $row->id }}" class="view_new_soul_btn mx-2" title="View New Soul"><i class="ri-eye-line" style="font-size: 20px;"></i></a>
                                                                
                                                                @if (Auth::user()->verified == 1)
                                                                    <a href="avascript:void(0)" id="{{ $row->id }}" class="edit_new_soul_btn mx-2" title="Edit New Soul"><i class="ri-edit-line text-success" style="font-size: 20px;"></i></a>
                                                                
                                                                    <a href="avascript:void(0)" id="{{ $row->id }}" class="delete_new_soul_btn mx-2" title="Delete New Soul"><i class="ri-delete-bin-6-line text-danger" style="font-size: 20px;"></i></a>
                                                                @endif
                                                            </td>
                                                        </tr>
       ...
       @endsection
        ...
        <script src="{{ url('public/assets/js/evangelism.js') }}">></script>
