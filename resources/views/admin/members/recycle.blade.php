                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($getRecord as $row)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="javascript:void(0)" id="{{ $row->id }}" class="view_members_btn mx-2" title="View Member"><i class="ri-eye-line" style="font-size: 20px;"></i></a>
                                                                <a href="javascript:void(0)" id="{{ $row->id }}" class="restore_members_btn mx-2" title="Restore Member"><i class="ri-restart-line text-danger" style="font-size: 20px;"></i></a>
                                                                
                                                                <a href="javascript:void(0)" id="{{ $row->id }}" class="perm_delete_member_btn mx-2" title="Delete Member"><i class="ri-delete-bin-2-line text-danger" style="font-size: 20px;"></i></a>
