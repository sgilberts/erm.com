...
$(document).ready(function() {
  ...
  // Add First Timer
  $("body").on("click", ".add_first_timer_btn", function(e) {
    e.preventDefault();
    ...
    if (my_btn == 'Add First Timer') {
        $("#add_first_timers_div").show();
        $("#edit_first_timers_div").hide();
        $("#add_first_timer_btn").text('Hide Add First Timer');
    } else {
        $("#add_first_timers_div").hide();
        $("#edit_first_timers_div").hide();
        $("#add_first_timer_btn").text('Add First Timer');
    }
...
//   // Edit User
  $("body").on("click", ".edit_first_timer_btn", function(e) {
    e.preventDefault();
    ...
    $("body").on("click", ".delete_first_timer_btn", function(e) {
        e.preventDefault();
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                Swal.fire({
                    ...
                    text: 'The first timer "'+response.first_name +' '+ response.last_name+'" will be moved into the first timers recycle bin!',
                    icon: 'warning',
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                if (response.alert_type == 'success') {
                                    ...
                                    Swal.fire({
                                        title: 'Deleted!',
                                        text: 'First Timer has been moved into the recycle bin.',
                                        icon: 'info',
    ...
    // Edit Depatment
    $("body").on("click", ".view_first_timer_btn", function(e) {
        e.preventDefault();
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $("#ft_text_ft_interest").html(response.ft_interest);
    ...
    $("body").on("click", ".perm_delete_first_timers_btn", function(e) {
        e.preventDefault();
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                Swal.fire({
                    title: 'Delete First Timer Foerever?',
                    text: 'The First Timer "'+response.first_name +' '+ response.last_name+'" will be permanently removed from the database.',
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonText: 'Yes, delete it!',
                    cancelButtonText: 'No, cancel!',
...
//     ///////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    // Temp Restore First Timerer
    $("body").on("click", ".restore_first_timers_btn", function(e) {
        e.preventDefault();
...
function SelectionForm(values, what_to_do, my_url) {
    ...
    if (what_to_do == 'del_sel_form') {
        myTitle = 'Delete All';
        msg = 'Are you sure you want to delete selected first timers?';
        msg2 = 'Selected first timer not deleted';
    } else if (what_to_do == 'restore_sel_form') {
        myTitle = 'Restore All';
        msg = 'Are you sure you want to restore selected first timers?';
        msg2 = 'Selected first timer not restored';
    } else if (what_to_do == 'perm_del_sel_form') {
        myTitle = 'Permanent Delete All';
        msg = 'Are you sure you want to delete selected first timers forever?';
        msg2 = 'Selected first timer not deleted forever';
    }
